...
<div class="row">
    ...
    <p>
        ...
        <?php } ?>
            ...
            <button id="optionBtn" type="button" class="btn btn-default" data-toggle="collapse" data-target="#setting"><i class="fas fa-ellipsis-v"></i> Options</button>
        </div>
    </p>
    </div>
    <div class="col-6">
...
<div id="setting" class="collapse row">
    <div class="col-4">
    <p>
